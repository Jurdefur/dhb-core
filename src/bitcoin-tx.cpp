...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " dhbcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  dhbcoin-tx [options] <hex-tx> [commands]  Update hex-encoded dhbcoin transaction\n" +
            "or:     dhbcoin-tx [options] -create [commands]   Create hex-encoded dhbcoin transaction\n" +
            "\n";
