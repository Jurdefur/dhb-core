...
const char * const BITCOIN_CONF_FILENAME = "dhbcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "DHBcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/DHBcoin";
#else
    // Unix
    return pathRet / ".dhbcoin";
#endif
#endif
}
