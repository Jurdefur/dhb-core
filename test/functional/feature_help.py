...
"""Verify that starting dhbcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start dhbcoin with -h for help text")
        ...
        self.log.info("Start dhbcoin with -version for version information")
        ...
        self.log.info("Start dhbcoind with -fakearg to make sure it does not start")
