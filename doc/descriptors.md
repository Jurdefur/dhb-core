# Support for Output Descriptors in DHBcoin Core

Since DHBcoin Core v0.17, there is support for Output Descriptors. This is a
...
on DHBcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing DHBcoin Core wallets, a convenience function `combo` is
